...
# exp21 = [("depth", [4]), ("batch_size", [64]), ("learning_rate", [1e-1, 1e-2]), ("kernel_size", [(3, 3)]), ("start_ch", [64]), ("dropout", [0.2]), ("low_pass", [1]), ("elastic_deform", [(8, 0.05)]), ("normalization", ["(GroupNormalization, 16)"]), ("lr_decay", [True]), ("lr_schedule", ["schedule1", "schedule2", "schedule3", "schedule4"]) ]
# grid_search("exp21", exp21, prev_results=True, res_file="results.csv")

# exp22 = [("depth", [4]), ("batch_size", [16]), ("learning_rate", [1e-5]), ("kernel_size", [(5, 5)]), ("start_ch", [32]), ("dropout", [0.4]), ("low_pass", [None]), ("high_pass", [None]), ("elastic_deform", [(4, 0.1)]), ("normalization", ["(GroupNormalization, 8)", "(GroupNormalization, 16)", "LayerNormalization", "InstanceNormalization", "BatchNormalization"])]
# grid_search("exp22", exp22, prev_results=True, res_file="results.csv")

# exp23 = [("depth", [4]), ("batch_size", [16]), ("learning_rate", [1e-4, 1e-5]), ("kernel_size", [(5, 5)]), ("start_ch", [32]), ("dropout", [0.4]), ("low_pass", [None]), ("high_pass", [None]), ("elastic_deform", [(4, 0.1)]), ("normalization", ["(GroupNormalization, 16)"]), ("lr_decay", [True]), ("lr_schedule", ["schedule1", "schedule2", "schedule3", "schedule4"])]
