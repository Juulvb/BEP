...
def load_generators(data_path, train_gen_args = dict(), val_gen_args = dict(), BATCH_SIZE = 32):    
    trainGene = getGenerator(BATCH_SIZE,data_path + '/train','train_frames','train_masks',train_gen_args,save_to_dir = None)
